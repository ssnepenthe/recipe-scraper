...
use SSNepenthe\RecipeParser\Parsers\PillsburyCom;
use SSNepenthe\RecipeParser\Schema\Recipe;

class PillsburyComTest extends ParserTestCase
{
    public function setUp()
    {
        $this->parser = new PillsburyCom;
    }
    ...
    public function test_parse_a_standard_recipe()
    {
        ...
        $recipe->setUrl('http://www.pillsbury.com/recipes/slow-cooker-cheesy-chicken-enchilada-chili/389d56ac-2840-4327-a23b-1303539a7248');
